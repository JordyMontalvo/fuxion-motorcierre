...
-- Keeping users for the tree, but altering it
ALTER TABLE users ALTER COLUMN rank_id DROP DEFAULT;
ALTER TABLE users ALTER COLUMN rank_id TYPE INT USING 1;
ALTER TABLE users ALTER COLUMN rank_id SET DEFAULT 1;
